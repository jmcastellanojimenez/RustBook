...
## APÉNDICE: COMANDO QUICK START

```bash
# Clonar y correr (2 minutos)
git clone https://github.com/user/marketflow
cd marketflow
docker-compose up -d
cargo run
...
**Stack corriendo localmente = Exactamente igual a producción**
